...
@Component({
  ...
  standalone: true,
  imports: [ToastMessageComponent, CommonModule, SharedModule, ReactiveFormsModule,],
  animations: [
    trigger('slideToggle', [
      transition(':enter', [
...
export class UpdateEmployeeComponent {
  ...
  callDDDesignation() {
    // this.get_DD_departmentId = event.target.value
    const reqBody = {
      EmpId: this.employeeDetails[0].EmpId,
      // DeptId: this.currentEmployeeDetails?.DeptId ? this.currentEmployeeDetails?.DeptId : this.basicDetailsForm?.get('DeptName')?.value,
      DeptId: this.basicDetailsForm?.get('DeptName')?.value ? this.basicDetailsForm?.get('DeptName')?.value : this.currentEmployeeDetails?.DeptId,
    }
    console.log(reqBody);
    ...
    this.hrmsService.employeeGetEmployee(reqBody).subscribe((res: any) => {
      ...
      if (res['msg'] == null || undefined) {
        ...
        this.basicDetailsForm?.patchValue({
          ...
          approverPerson: this.currentEmployeeDetails?.ApproverId,
  ...
  updateBasicDetials() {
    ...
    if (this.basicDetailsForm.valid) {
      const reqBody = {
        ...
        ReportId: Number(this.basicDetailsForm?.get('approverPerson').value) ? Number(this.basicDetailsForm?.get('approverPerson').value) : this.currentEmployeeDetails?.EmpTypeId,
