...
public class PayrollService {
    ...
    private EmployeeSalaryDetailsViewModel mapSalaryDetail(EmployeeSalaryDetails s) {
        ...
        vm.setPerviousCtc(s.getPerviousCtc());
        vm.setRecordStatus(s.getRecordStatus());
        vm.setIsFixed(s.getIsFixed());
        vm.setIsVariable(s.getIsVariable());
        vm.setPeriod(s.getPeriod());
        vm.setVariableId(s.getVariableId());
        vm.setVariableName(s.getVariableName());
        vm.setVariableCode(s.getVariableCode());
        vm.setVariableAmt(s.getVariableAmt());
        vm.setIsArrear(s.getIsArrear());
        vm.setArrearAmt(s.getArrearAmt());
        vm.setIsClearArrear(s.getIsClearArrear());
        vm.setPendingMonth(s.getPendingMonth());
        vm.setArrearYear(s.getArrearYear());
        vm.setArrearMonth(s.getArrearMonth());
        vm.setDescriptionforArrear(s.getDescriptionforArrear());
        vm.setIsActive(s.getIsActive());
        vm.setIsUpdated(s.getIsUpdated());
        vm.setIsDeleted(s.getIsDeleted());
        vm.setCreatedBy(s.getCreatedBy());
