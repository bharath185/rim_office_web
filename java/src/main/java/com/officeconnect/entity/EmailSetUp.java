...
public class EmailSetUp {
    ...
    public String getEmailIdField() { return emailIdField; }
    public void setEmailIdField(String emailIdField) { this.emailIdField = emailIdField; }
