...
public class EmployeeMasterLog {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "EMlogId")
    private Integer emlogId;
    ...
    @Column(name = "UpdatedEmpCode")
    private String updatedEmpCode;
    ...
    public Integer getEmlogId() { return emlogId; }
    public void setEmlogId(Integer emlogId) { this.emlogId = emlogId; }
    ...
    public String getUpdatedEmpCode() { return updatedEmpCode; }
    public void setUpdatedEmpCode(String updatedEmpCode) { this.updatedEmpCode = updatedEmpCode; }
